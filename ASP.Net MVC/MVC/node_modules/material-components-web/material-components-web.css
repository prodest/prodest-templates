...
.mdc-button--stroked {
  ...
  border-style: solid;
  line-height: 32px; }
  .mdc-button--theme-dark .mdc-button--stroked,
  .mdc-theme--dark .mdc-button--stroked {
    /* @alternate */
    border-color: white;
...
.mdc-button--primary {
  ...
  .mdc-button--primary.mdc-button--raised, .mdc-button--primary.mdc-button--unelevated {
    ...
    background-color: var(--mdc-theme-primary, #1e88e5);
    /* @alternate */
    color: white;
    ...
    .mdc-button--primary.mdc-button--raised.mdc-ripple-upgraded--foreground-deactivation::after, .mdc-button--primary.mdc-button--unelevated.mdc-ripple-upgraded--foreground-deactivation::after {
      transform: translate(var(--mdc-ripple-fg-translate-end, 0)) scale(var(--mdc-ripple-fg-scale, 1));
      animation: 83ms mdc-ripple-fg-opacity-out; }
  .mdc-button--primary.mdc-button--stroked {
    /* @alternate */
    border-color: #1e88e5;
    border-color: var(--mdc-theme-primary, #1e88e5); }
    .mdc-button--theme-dark .mdc-button--primary.mdc-button--stroked,
    .mdc-theme--dark .mdc-button--primary.mdc-button--stroked {
      /* @alternate */
      border-color: #1e88e5;
      border-color: var(--mdc-theme-primary, #1e88e5); }
...
.mdc-button--accent {
  ...
  /* @alternate */
  color: #f06292;
  color: var(--mdc-theme-secondary, #f06292); }
  ...
  .mdc-button--accent::before {
    background-color: rgba(240, 98, 146, 0.16);
    position: absolute;
    top: calc(50% - 100%);
    left: calc(50% - 100%);
    width: 200%;
  ...
  .mdc-button--accent.mdc-button--raised, .mdc-button--accent.mdc-button--unelevated {
    ...
    background-color: var(--mdc-theme-secondary, #f06292);
    /* @alternate */
    color: rgba(0, 0, 0, 0.87);
    ...
    .mdc-button--accent.mdc-button--raised.mdc-ripple-upgraded--foreground-deactivation::after, .mdc-button--accent.mdc-button--unelevated.mdc-ripple-upgraded--foreground-deactivation::after {
      transform: translate(var(--mdc-ripple-fg-translate-end, 0)) scale(var(--mdc-ripple-fg-scale, 1));
      animation: 83ms mdc-ripple-fg-opacity-out; }
  .mdc-button--accent.mdc-button--stroked {
    /* @alternate */
    border-color: #f06292;
    border-color: var(--mdc-theme-secondary, #f06292); }
    .mdc-button--theme-dark .mdc-button--accent.mdc-button--stroked,
    .mdc-theme--dark .mdc-button--accent.mdc-button--stroked {
      /* @alternate */
      border-color: #f06292;
      border-color: var(--mdc-theme-secondary, #f06292); }
...
fieldset:disabled .mdc-button--stroked, .mdc-button--stroked:disabled {
  border-color: rgba(0, 0, 0, 0.38); }
  .mdc-button--theme-dark fieldset:disabled .mdc-button--stroked,
  .mdc-theme--dark fieldset:disabled .mdc-button--stroked, .mdc-button--theme-dark .mdc-button--stroked:disabled,
...
.mdc-checkbox {
  ...
  .mdc-checkbox::before {
    ...
    @supports (background-color: color(green a(10%))) {
      .mdc-checkbox::before {
        background-color: color(var(--mdc-theme-primary, #1e88e5) a(14%)); } }
  ...
  .mdc-checkbox__background {
    ...
    .mdc-checkbox__background::before {
      ...
      /* @alternate */
      background: #1e88e5;
      background: var(--mdc-theme-primary, #1e88e5); }
...
.mdc-icon-toggle--accent {
  ...
  .mdc-icon-toggle--accent::before {
    ...
    @supports (background-color: color(green a(10%))) {
      .mdc-icon-toggle--accent::before {
        background-color: color(var(--mdc-theme-secondary, #f06292) a(14%)); } }
...
.mdc-ripple-surface {
  ...
  .mdc-ripple-surface--primary::before {
    ...
    @supports (background-color: color(green a(10%))) {
      .mdc-ripple-surface--primary::before {
        background-color: color(var(--mdc-theme-primary, #1e88e5) a(16%)); } }
  ...
  .mdc-ripple-surface--accent::before {
    ...
    @supports (background-color: color(green a(10%))) {
      .mdc-ripple-surface--accent::before {
        background-color: color(var(--mdc-theme-secondary, #f06292) a(16%)); } }
...
.mdc-select {
  ...
  .mdc-select:focus {
    ...
    border-bottom-color: var(--mdc-theme-primary, #1e88e5);
    outline: none;
    background-color: rgba(0, 0, 0, 0.06); }
  [dir="rtl"] .mdc-select, .mdc-select[dir="rtl"] {
...
.mdc-slider {
  ...
  .mdc-slider__thumb {
    /* @alternate */
    fill: #1e88e5;
    fill: var(--mdc-theme-primary, #1e88e5);
    /* @alternate */
    stroke: #1e88e5;
    stroke: var(--mdc-theme-primary, #1e88e5);
    position: absolute;
    top: 0;
    left: 0;
    transform: scale(0.571);
...
:root {
  ...
  --mdc-theme-primary-light: #5eaaec;
  --mdc-theme-primary-dark: #1363a8;
  --mdc-theme-secondary: #f06292;
  --mdc-theme-secondary-light: #f6a3bf;
  --mdc-theme-secondary-dark: #ea2165;
...
.mdc-theme--primary {
  ...
  color: var(--mdc-theme-primary, #1e88e5) !important; }

.mdc-theme--primary-light {
  /* @alternate */
  color: #5eaaec !important;
  color: var(--mdc-theme-primary-light, #5eaaec) !important; }

.mdc-theme--primary-dark {
  /* @alternate */
  color: #1363a8 !important;
  color: var(--mdc-theme-primary-dark, #1363a8) !important; }
...
.mdc-theme--secondary-light {
  /* @alternate */
  color: #f6a3bf !important;
  color: var(--mdc-theme-secondary-light, #f6a3bf) !important; }

.mdc-theme--secondary-dark {
  /* @alternate */
  color: #ea2165 !important;
  color: var(--mdc-theme-secondary-dark, #ea2165) !important; }
...
.mdc-theme--primary-bg {
  ...
  background-color: var(--mdc-theme-primary, #1e88e5) !important; }

.mdc-theme--primary-light-bg {
  /* @alternate */
  background-color: #5eaaec !important;
  background-color: var(--mdc-theme-primary-light, #5eaaec) !important; }

.mdc-theme--primary-dark-bg {
  /* @alternate */
  background-color: #1363a8 !important;
  background-color: var(--mdc-theme-primary-dark, #1363a8) !important; }
...
.mdc-theme--secondary-light-bg {
  /* @alternate */
  background-color: #f6a3bf !important;
  background-color: var(--mdc-theme-secondary-light, #f6a3bf) !important; }

.mdc-theme--secondary-dark-bg {
  /* @alternate */
  background-color: #ea2165 !important;
  background-color: var(--mdc-theme-secondary-dark, #ea2165) !important; }
